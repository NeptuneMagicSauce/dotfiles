...
"Toggle Emojify mode in many buffers.
Specifically, Emojify mode is enabled in all buffers where
...
"Toggle Emojify-Mode-Line mode in many buffers.
Specifically, Emojify-Mode-Line mode is enabled in all buffers where
