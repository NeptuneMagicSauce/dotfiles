...
alias gd='git diff -w'
alias gdd='git -c pager.diff="delta -s" diff -w'
alias gddu='git -c pager.diff=delta diff -w'
# alias gdu='gd -U0'
# alias gddu='gdd -U0'
# alias gdud='gddu'
...
# export LESS_TERMCAP_so=$'\e[01;44;37m' # begin reverse video # buggy on ghostty: not enough contrast
export LESS_TERMCAP_so=$'\e[38;2;255;255;255;48;2;14;126;204m' # okay on ghostty
